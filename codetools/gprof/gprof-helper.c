...
static int (*pthread_create_orig)(pthread_t *__restrict, __const pthread_attr_t *__restrict,
...
int pthread_create(pthread_t *__restrict thread, __const pthread_attr_t *__restrict attr,
